...
| Helmet face and cheeks | Helmet detail | Open | Concept face is a steel plate with glowing slots, framed by thick cheek plates flush with the crown. |
| Head scale | Front, side, back | Open | Model 5.6 heads; concept 6.5 to 7.5. Reduce moderately, keeping gameplay readability. |
